  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-indigo-600/20 rounded-full blur-[120px] opacity-50 animate-pulse"></div>
        <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-violet-600/20 rounded-full blur-[120px] opacity-50 animate-pulse delay-1000"></div>
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800/50 rounded-2xl p-8 shadow-2xl ring-1 ring-white/5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  type="email"
                  {...register('email')}
                  className="block w-full pl-10 pr-3 py-3 bg-slate-950/50 border border-slate-700 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all duration-200 sm:text-sm"
                  placeholder="nome@empresa.com"
                  autoComplete="email"
                />
              </div>
              {errors.email && (
                <p className="text-red-400 text-xs flex items-center gap-1 mt-1 animate-in fade-in slide-in-from-top-1">
          ...
          <div className="mt-8 pt-6 border-t border-slate-800/50">
             ...
             <div className="grid grid-cols-2 gap-3 mb-6">
                <a href="http://localhost:3000/api/auth/google" className="flex items-center justify-center px-4 py-2.5 border border-slate-700 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white transition-colors text-sm font-medium">
                ...
                <a href="http://localhost:3000/api/auth/github" className="flex items-center justify-center px-4 py-2.5 border border-slate-700 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white transition-colors text-sm font-medium">
